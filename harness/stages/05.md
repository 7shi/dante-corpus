...
[`stages/06.md`](06.md), which opens with an audit of the soft classification
...
own corpus-wide readout ([`stages/04.md`](04.md) record S4.3). Left as-is,
...
numbers for the record live in [`stages/04.md`](04.md) S4.3 and in S5.1
...
line here: [`stages/06.md`](06.md) §2, evidence in [`../SOFT.md`](../SOFT.md) §4.2.
