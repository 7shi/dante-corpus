# Stage 1 Record: Autonomous Inference & Capability Benchmark (`harness/stages/01.md`)
...
4. ~~**Validator rejects gold-correct complement rows**~~ — RESOLVED (2026-08-22,
   ...
   argument, while the spec (`../runner/PLAN.md` §3.2 item 2, and the agent prompt) scopes
