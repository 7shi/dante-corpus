...
([`stages/05.md`](05.md) S5.8); everything left is soft, and it is a large
...
([`stages/05.md`](05.md) S5.5), so unlike the hard track the stage's **default
...
**Consequence for method.** [`stages/05.md`](05.md) §5's resolution still
...
The counterpart to [`stages/05.md`](05.md) S5.4, and the same reason for
