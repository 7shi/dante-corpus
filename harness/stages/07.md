...
in [`stages/06.md`](06.md) §3 and waits for a stage of its own; nothing about
...
2. **Soft level 2** — still a design question before it is a run. Candidates and
   the eligibility list stay in [`stages/06.md`](06.md) §3, unchanged and
...
3. **The standing authority question** — is `dante_corpus/skel/repairs.py` an
   ...
   toolchain that built gold. [`stages/06.md`](06.md) S6.3 prices both routes
