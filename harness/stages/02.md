...
(`../extractor/PLAN.md` §2.1 as it then stood; that spec went with the miner
on 2026-09-07).
...
(`../extractor/PLAN.md` §2.2 as it then stood; removed 2026-09-07) — the direct lever on the M1.4 `obl:di` / `obl:in`
...
Stage-2 deliverable: the two-tier engine of `../extractor/PLAN.md` §3 as it then
stood (removed 2026-09-07) — Tier-1
...
`HybridEngine.run_unit`, every disk write gated on the three criteria now at
extractor/PLAN.md §3.
