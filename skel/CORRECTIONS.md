...
> **Context for Phase 9 (Grammar Harness)**:
> The deterministic grammar engine comprises 130 registered rules documented in [`RULES.md`](RULES.md).
> The entries documented in this file represent positions and phenomena that lie **outside the deterministic rule system** — including authorial/editorial manual corrections, verbless speech frame conventions, structural outlier fixes, and upstream dependency/morphology/case retags.
