...
- `proper_noun/` — independent of the layer stack above: a standalone sample of processing Dante's Italian text with an LLM, extracting proper nouns line by line (see [`proper_noun/README.md`](proper_noun/README.md)).
